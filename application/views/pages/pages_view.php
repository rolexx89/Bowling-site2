	...
	<tr class="mark">
	 ...
	 <?php foreach ($all_users as $item) { ?>
			...
			<td><li class="ui-button ui-widget ui-state-default ui-corner-all" title=".ui-icon-person">
                        <a class="ui-icon ui-icon-person" href="<?= base_url() . "users/show/$item[id]"; ?>"><?php echo htmlspecialchars($item['id']); ?></a>
                        </li></td>
			...
			<td align="center">
                       ...
                       <a class="ui-icon ui-icon-trash" href="<?php echo base_url(); ?>users/userremove/<?php echo htmlspecialchars($item['id']); ?>">del</a>
                       </li>
