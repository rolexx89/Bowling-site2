...
<?php if(isset($currentGameData['games-id'])) { ?>
        <h2>Game List</h2>
        <?php
                if(count($currentGameData['games-id']) == 0) { ?>
                        No games created
                <?php } else foreach ( $currentGameData['games-id'] as $item_id ) { ?>
                        <a href="<?=base_url();?>games/show/id/<?=$item_id;?>">&nbsp;<?=$item_id;?>&nbsp;</a>
                <?php }
        ?>
        <hr>
        <a href="<?=base_url();?>games/newgame">Begin New Game</a>
<?php } ?>


<?php if(isset($currentGameData['game-status'])) {
